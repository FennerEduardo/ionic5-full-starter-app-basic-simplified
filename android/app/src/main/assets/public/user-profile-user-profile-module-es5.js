...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-profile-user-profile-module"], {
  ...
  function srcAppUserProfileUserProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_profile_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./user-profile.page */
    "./src/app/user/profile/user-profile.page.ts");
    /* harmony import */


    var _user_profile_resolver__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    UserProfilePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [_user_profile_resolver__WEBPACK_IMPORTED_MODULE_9__["UserProfileResolver"], _user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"]],
      imports: [[_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_6__["ComponentsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UserProfilePageModule, {
        ...
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_6__["ComponentsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppUserProfileUserProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function UserProfilePage_ion_col_56_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UserProfilePage_ion_col_64_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(UserProfilePage, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscriptions = this.route.data.subscribe(function (resolvedRouteData) {
            ...
            _this2.subscriptions = _utils_resolver_helper__WEBPACK_IMPORTED_MODULE_2__["ResolverHelper"].extractData(resolvedRouteData.data, _user_profile_model__WEBPACK_IMPORTED_MODULE_3__["UserProfileModel"]).subscribe(function (state) {
    ...
    UserProfilePage.ɵfac = function UserProfilePage_Factory(t) {
      return new (t || UserProfilePage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]));
    };
    ...
    UserProfilePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      hostVars: 2,
      hostBindings: function UserProfilePage_HostBindings(rf, ctx) {
        if (rf & 2) {
      ...
      decls: 65,
      vars: 14,
      consts: [[1, "ion-no-border"], ["slot", "start"], [1, "user-profile-content"], [1, "user-details-section"], [1, "user-image-wrapper"], [3, "ratio"], ["animation", "spinner", 1, "user-image", 3, "src"], [1, "user-info-wrapper"], [1, "user-data-row"], ["size", "9"], [1, "user-name"], [3, "data"], [1, "user-title"], [1, "membership-col"], [1, "user-membership"], [1, "actions-row"], [1, "main-actions"], ["size", "small", "color", "primary", 1, "call-to-action-btn"], ["size", "small", "color", "medium", 1, "call-to-action-btn"], [1, "secondary-actions"], ["size", "small", "fill", "clear", "color", "medium", 1, "more-btn"], ["slot", "icon-only", "ios", "ellipsis-horizontal", "md", "ellipsis-vertical"], [1, "user-stats-section"], ["size", "4", 1, "user-stats-wrapper"], [1, "stat-value"], [1, "stat-name"], [1, "user-about-section"], [1, "details-section-title"], [1, "user-description"], ["animation", "bouncing", "lines", "4", 3, "data"], [1, "user-friends-section"], [1, "heading-row"], [1, "heading-call-to-action", 3, "routerLink"], [1, "friends-row"], ["class", "friend-item", "size", "2", 4, "ngFor", "ngForOf"], [1, "user-photos-section"], [1, "heading-call-to-action"], [1, "pictures-row"], ["class", "picture-item", "size", "2", 4, "ngFor", "ngForOf"], ["size", "2", 1, "friend-item"], [1, "friend-picture", 3, "src"], [1, "friend-name"], ["size", "2", 1, "picture-item"], [1, "user-photo-image", 3, "display", "src"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserProfilePage, [{
        ...
        args: [{
          ...
          styleUrls: ['./styles/user-profile.page.scss', './styles/user-profile.shell.scss', './styles/user-profile.ios.scss', './styles/user-profile.md.scss']
        }]
      }], function () {
        return [{
  ...
  function srcAppUserProfileUserProfileResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UserProfileResolver.ɵfac = function UserProfileResolver_Factory(t) {
      return new (t || UserProfileResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]));
    };

    UserProfileResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserProfileResolver, [{
