      ...
      _createClass(DataStorePaginationPage, [{
        ...
        value: function ngOnInit() {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(this.remoteApiDataStore.state, newDataObservable).subscribe(function (result) {
            ...
            if (_this7.loadMorePages) {
              _this7.pagedUsers = result;
            }

            if (_this7.currentPage === 4) {
              _this7.loadMorePages = false;
            }
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(this.openDataStore.state, newDataObservable).subscribe(function (data) {
            ...
            if (data.isShell) {
              ...
              _this8.shellUsers = shellsAsObservables;
            } else {
              var _this8$stackedUsers;
              ...
              (_this8$stackedUsers = _this8.stackedUsers).push.apply(_this8$stackedUsers, _toConsumableArray(dataWithShell));
            }
          });
        }
      }, {
