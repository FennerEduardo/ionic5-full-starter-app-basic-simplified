...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-friends-user-friends-module"], {
  ...
  function srcAppUserFriendsUserFriendsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_friends_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./user-friends.page */
    "./src/app/user/friends/user-friends.page.ts");
    /* harmony import */


    var _user_friends_resolver__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    UserFriendsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [_user_friends_resolver__WEBPACK_IMPORTED_MODULE_9__["UserFriendsResolver"], _user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"]],
      ...
      _createClass(UserFriendsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscriptions = this.route.data.subscribe(function (resolvedRouteData) {
            ...
            _this2.subscriptions = _utils_resolver_helper__WEBPACK_IMPORTED_MODULE_2__["ResolverHelper"].extractData(resolvedRouteData.data, _user_friends_model__WEBPACK_IMPORTED_MODULE_3__["UserFriendsModel"]).subscribe(function (state) {
              _this2.data = state;
