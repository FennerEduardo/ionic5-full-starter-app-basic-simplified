...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["travel-details-travel-details-module"], {
  ...
  function srcAppTravelDetailsTravelDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _travel_details_plain_resolver__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var routes = [{
      ...
      resolve: {
        data: _travel_details_resolver__WEBPACK_IMPORTED_MODULE_9__["TravelDetailsResolver"] // data: TravelDetailsPlainResolver
    ...
    TravelDetailsPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: TravelDetailsPageModule
    });
    TravelDetailsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function TravelDetailsPageModule_Factory(t) {
        return new (t || TravelDetailsPageModule)();
      },
      providers: [_travel_details_resolver__WEBPACK_IMPORTED_MODULE_9__["TravelDetailsResolver"], _travel_details_plain_resolver__WEBPACK_IMPORTED_MODULE_10__["TravelDetailsPlainResolver"], _travel_service__WEBPACK_IMPORTED_MODULE_7__["TravelService"]],
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TravelDetailsPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TravelDetailsPageModule, [{
  ...
  function srcAppTravelDetailsTravelDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _travel_details_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function TravelDetailsPage_ion_col_32_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TravelDetailsPage_li_40_ng_container_5_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var schedule_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function TravelDetailsPage_li_40_ng_container_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function TravelDetailsPage_li_40_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TravelDetailsPage_div_49_ion_col_4_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var placeToStay_r11 = ctx.$implicit;
    ...
    function TravelDetailsPage_div_49_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TravelDetailsPage_div_50_ion_col_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-col", 48);
      ...
      if (rf & 2) {
        var placeToEat_r13 = ctx.$implicit;
    ...
    function TravelDetailsPage_div_50_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 44);
    ...
    function TravelDetailsPage_div_51_ion_row_3_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var relatedActivity_r15 = ctx.$implicit;
    ...
    function TravelDetailsPage_div_51_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(TravelDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscriptions = this.route.data.subscribe(function (resolvedRouteData) {
            ...
            _this2.subscriptions = _utils_resolver_helper__WEBPACK_IMPORTED_MODULE_2__["ResolverHelper"].extractData(resolvedRouteData.data, _travel_details_model__WEBPACK_IMPORTED_MODULE_3__["TravelDetailsModel"]).subscribe(function (state) {
    ...
    TravelDetailsPage.ɵfac = function TravelDetailsPage_Factory(t) {
      return new (t || TravelDetailsPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]));
    };

    TravelDetailsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: TravelDetailsPage,
      selectors: [["app-travel-details"]],
      hostVars: 2,
      hostBindings: function TravelDetailsPage_HostBindings(rf, ctx) {
        if (rf & 2) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TravelDetailsPage, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
          selector: 'app-travel-details',
          templateUrl: './travel-details.page.html',
          styleUrls: ['./styles/travel-details.page.scss', './styles/travel-details.shell.scss']
        }]
      }], function () {
        return [{
  ...
  function srcAppTravelDetailsTravelDetailsPlainResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    TravelDetailsPlainResolver.ɵfac = function TravelDetailsPlainResolver_Factory(t) {
      return new (t || TravelDetailsPlainResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_travel_service__WEBPACK_IMPORTED_MODULE_1__["TravelService"]));
    };

    TravelDetailsPlainResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: TravelDetailsPlainResolver,
      factory: TravelDetailsPlainResolver.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TravelDetailsPlainResolver, [{
  ...
  function srcAppTravelDetailsTravelDetailsResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    TravelDetailsResolver.ɵfac = function TravelDetailsResolver_Factory(t) {
      return new (t || TravelDetailsResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_travel_service__WEBPACK_IMPORTED_MODULE_1__["TravelService"]));
    };

    TravelDetailsResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: TravelDetailsResolver,
      factory: TravelDetailsResolver.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TravelDetailsResolver, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
      }], function () {
        return [{
          type: _travel_service__WEBPACK_IMPORTED_MODULE_1__["TravelService"]
