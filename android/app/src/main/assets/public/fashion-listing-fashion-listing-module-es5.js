...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["fashion-listing-fashion-listing-module"], {
  ...
  function srcAppFashionListingFashionListingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FashionListingPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: FashionListingPageModule
    });
    FashionListingPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function FashionListingPageModule_Factory(t) {
        return new (t || FashionListingPageModule)();
      },
      providers: [_fashion_listing_resolver__WEBPACK_IMPORTED_MODULE_9__["FashionListingResolver"], _fashion_service__WEBPACK_IMPORTED_MODULE_7__["FashionService"]],
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FashionListingPageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FashionListingPageModule, [{
  ...
  function srcAppFashionListingFashionListingPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _fashion_listing_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      _createClass(FashionListingPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscriptions = this.route.data.subscribe(function (resolvedRouteData) {
            ...
            _this.subscriptions = _utils_resolver_helper__WEBPACK_IMPORTED_MODULE_2__["ResolverHelper"].extractData(resolvedRouteData.data, _fashion_listing_model__WEBPACK_IMPORTED_MODULE_3__["FashionListingModel"]).subscribe(function (state) {
              _this.listing = state;
            }, function (error) {});
          }, function (error) {});
    ...
    FashionListingPage.ɵfac = function FashionListingPage_Factory(t) {
      return new (t || FashionListingPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]));
    };

    FashionListingPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FashionListingPage, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
          selector: 'app-fashion-listing',
          templateUrl: './fashion-listing.page.html',
          styleUrls: ['./styles/fashion-listing.page.scss', './styles/fashion-listing.shell.scss']
        }]
      }], function () {
        return [{
  ...
  function srcAppFashionListingFashionListingResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FashionListingResolver.ɵfac = function FashionListingResolver_Factory(t) {
      return new (t || FashionListingResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_fashion_service__WEBPACK_IMPORTED_MODULE_1__["FashionService"]));
    };

    FashionListingResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FashionListingResolver, [{
