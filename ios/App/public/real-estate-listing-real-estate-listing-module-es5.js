...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["real-estate-listing-real-estate-listing-module"], {
  ...
  function srcAppRealEstateListingRealEstateListingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RealEstateListingPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [_real_estate_listing_resolver__WEBPACK_IMPORTED_MODULE_9__["RealEstateListingResolver"], _real_estate_service__WEBPACK_IMPORTED_MODULE_7__["RealEstateService"]],
  ...
  function srcAppRealEstateListingRealEstateListingPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _real_estate_listing_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function RealEstateListingPage_div_7_ion_icon_17_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RealEstateListingPage_div_7_ion_col_45_ion_col_5_ion_icon_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ion-icon", 41);
      }

      if (rf & 2) {
        var amenity_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("src", amenity_r7.icon);
      }
    }

    function RealEstateListingPage_div_7_ion_col_45_ion_col_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RealEstateListingPage_div_7_ion_col_45_ion_col_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RealEstateListingPage_div_7_ion_col_45_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(RealEstateListingPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscriptions = this.route.data.subscribe(function (resolvedRouteData) {
            ...
            _this.subscriptions = _utils_resolver_helper__WEBPACK_IMPORTED_MODULE_2__["ResolverHelper"].extractData(resolvedRouteData.data, _real_estate_listing_model__WEBPACK_IMPORTED_MODULE_3__["RealEstateListingModel"]).subscribe(function (state) {
              _this.listing = state;
            }, function (error) {});
          }, function (error) {});
    ...
    RealEstateListingPage.ɵfac = function RealEstateListingPage_Factory(t) {
      return new (t || RealEstateListingPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RealEstateListingPage, [{
        ...
        args: [{
          ...
          styleUrls: ['./styles/real-estate-listing.page.scss', './styles/real-estate-listing.shell.scss']
        }]
      }], function () {
        return [{
  ...
  function srcAppRealEstateListingRealEstateListingResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RealEstateListingResolver.ɵfac = function RealEstateListingResolver_Factory(t) {
      return new (t || RealEstateListingResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_real_estate_service__WEBPACK_IMPORTED_MODULE_1__["RealEstateService"]));
    };

    RealEstateListingResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RealEstateListingResolver, [{
