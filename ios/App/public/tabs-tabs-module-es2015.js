...
TabsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TabsPage, selectors: [["app-tabs"]], decls: 14, vars: 0, consts: [["slot", "bottom"], ["tab", "categories"], ["name", "list-outline"], [1, "tab-title"], ["tab", "user"], ["name", "person-outline"], ["tab", "notifications"], ["name", "notifications-outline"]], template: function TabsPage_Template(rf, ctx) { if (rf & 1) {
